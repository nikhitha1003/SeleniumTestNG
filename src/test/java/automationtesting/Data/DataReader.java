...
public class DataReader {
	...
	public List<HashMap<String, String>> getJsonDataToHashMap() throws IOException {
		...
		String jsonContent = FileUtils.readFileToString(new File(System.getProperty("user.dir")+"\\src\\test\\java\\automationtesting\\Data\\PurchaseOrder.json"), StandardCharsets.UTF_8);
